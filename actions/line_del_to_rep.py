...
class DelimitationToReplantejament:
    ...
    def transform_del_to_rep(self):
        ...
        with edit(self.new_lin_tram):
            ...
            for feat_ppta in self.lin_tram_ppta.getFeatures():
                ...
                # new_feat['ID_LINIA'] = line_id  # TODO
        ...
        QgsVectorFileWriter.writeAsVectorFormatV2(self.new_lin_tram, os.path.join(self.carto_dir, 'Lin_Tram_new.shp'),
                                                  QgsCoordinateTransformContext(), options)
        QgsProject.instance().addMapLayer(self.lin_tram)
    ...
    def update_geo_tram(self):
        ...
        for tram_id in tram_id_list:
            ...
            # new_geo_tram['ID_LINIA'] = line_id   # TODO
